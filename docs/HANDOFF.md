...
**Prossimo lavoro pianificato**: design + implementazione dei **canali di lega user-owned** (vedi sezione "Idee UX per una futura v2.0" sopra per contesto tecnico, decisioni aperte e file coinvolti). Segui lo stile ADR-first: leggere ADR 0008 (+ amendment) e ADR 0012 prima di proporre il design, scrivere una nuova ADR (0015) con le decisioni prese prima di implementare.
